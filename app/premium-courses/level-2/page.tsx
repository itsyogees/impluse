...
import { Level2StudyMaterial, Level2Quiz } from './data';
...
export default function Level2Page() {
    ...
    const handleAnswerSelect = (optionKey: string) => {
        ...
        const correct = optionKey === Level2Quiz[currentQn].answer;
        ...
        setTimeout(() => {
            if (currentQn < Level2Quiz.length - 1) {
    ...
    const totalStudyPages = Level2StudyMaterial.length;
    const currentStudy = Level2StudyMaterial[currentStudyPage];
        ...
        <div className="min-h-screen bg-[#020C0E] text-text-primary font-sans relative overflow-x-hidden">
            ...
            <header className="sticky top-0 z-50 bg-[#05161A]/80 backdrop-blur-xl border-b border-green-500/10 px-6 py-4 shadow-2xl">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="text-center">
                        <h1 className="font-cinzel text-xl sm:text-2xl font-bold tracking-[2px] text-green-500">
                            Level 2: Trading Psychology
                        </h1>
                        <p className="text-xs text-text-secondary mt-0.5 font-medium">Trading Psychology & Success Formula</p>
                    </div>

                    <Link
                        href="/"
                        className="p-2.5 rounded-xl bg-white/5 hover:bg-green-500/10 transition-all text-text-secondary hover:text-green-500"
                    >
            ...
            <main className="max-w-5xl mx-auto px-6 py-8 relative z-10">
                ...
                <div className="flex justify-center mb-10">
                    <div className="inline-flex p-1.5 bg-[#0A2228] border border-green-500/10 rounded-2xl shadow-xl">
                        <button
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'study' ? (
                        ...
                        >
                            {/* Progress Section */}
                            <div className="bg-[#05161A] border border-green-500/10 rounded-3xl p-6 shadow-xl">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                                    ...
                                    <span className="text-xs font-bold text-green-500 bg-green-500/10 px-3 py-1.5 rounded-full self-start sm:self-center">
                            ...
                            {/* Main Content Card */}
                            <div className="bg-[#05161A] border border-green-500/20 rounded-[40px] p-8 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.3)] relative overflow-hidden group">
                                <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                                    <BookOpen className="w-32 h-32 text-green-500" />
                                </div>

                                <h2 className="text-2xl sm:text-3xl font-bold text-green-500 mb-8 leading-tight">
                                    {currentStudy.title}
                                </h2>

                                <div className="h-0.5 w-20 bg-green-500/30 mb-8" />
                            ...
                            <div className="flex items-center justify-between gap-6 pt-4">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-3 bg-green-500 text-black py-4 px-10 rounded-2xl font-bold shadow-[0_10px_30px_rgba(34,197,94,0.2)] hover:bg-green-400 transition-all transform hover:scale-105 active:scale-95 group"
                                >
                            ...
                            {!showResults ? (
                                <div className="space-y-8">
                                    ...
                                    <div className="text-center space-y-4">
                                        ...
                                        <h2 className="text-3xl font-bold text-white">Question {currentQn + 1} of {Level2Quiz.length}</h2>
                                        <div className="w-full bg-white/5 rounded-full h-1.5 max-w-xs mx-auto overflow-hidden">
                                            <motion.div
                                                className="bg-green-500 h-full rounded-full"
                                                animate={{ width: `${((currentQn + 1) / Level2Quiz.length) * 100}%` }}
                                            />
                                        </div>
                                    </div>

                                    {/* Question Card */}
                                    <div className="bg-[#05161A] border border-green-500/20 rounded-[40px] p-8 md:p-10 shadow-2xl relative">
                                        <h3 className="text-xl sm:text-2xl font-bold text-center mb-10 leading-relaxed text-white">
                                            {Level2Quiz[currentQn]?.question}
                                        </h3>

                                        <div className="grid grid-cols-1 gap-4">
                                            {Level2Quiz[currentQn]?.options.map((option, idx) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`w-full p-5 rounded-2xl font-bold text-left transition-all relative overflow-hidden group border-2 ${isSelected
                                                            ...
                                                            : 'bg-[#0A2228] border-white/5 text-text-secondary hover:border-green-500/50 hover:text-text-primary'
                                                            }`}
                                                    >
                                    ...
                                    <div className="flex justify-between items-center px-4">
                                        <button
                                            ...
                                            className="text-text-secondary hover:text-green-500 font-bold transition-colors disabled:opacity-0"
                                        >
                                            ← Previous Question
                                        </button>
                                ...
                                <motion.div
                                    ...
                                    className="bg-[#05161A] border-2 border-green-500 rounded-[40px] p-12 text-center shadow-[0_0_80px_rgba(34,197,94,0.15)]"
                                >
                                    ...
                                    <p className="text-text-secondary mb-10 text-lg">You&apos;ve successfully completed the Level 2 Mastery Challenge.</p>
                                    ...
                                    <div className="grid grid-cols-2 gap-6 mb-12">
                                        ...
                                        <div className="bg-[#0A2228] p-6 rounded-3xl border border-white/5">
                                            <p className="text-3xl font-black text-green-400">{Math.round((score / Level2Quiz.length) * 100)}%</p>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                                        <button
                                            onClick={startQuiz}
                                            className="px-10 py-4 bg-white/5 hover:bg-white/10 rounded-2xl font-bold transition-all border border-white/10 text-white"
                                        >
                                            Retake Quiz
                                        </button>
                                        <Link
                                            href="/premium-courses"
                                            className="px-10 py-4 bg-green-500 text-black rounded-2xl font-bold transition-all hover:bg-green-400 shadow-lg shadow-green-500/20"
                                        >
                                            Next Level →
                                        </Link>
                                    </div>
